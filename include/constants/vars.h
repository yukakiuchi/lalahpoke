...
#define VAR_LEVEL_CAP                                    0x404E // レベル制限フラグ
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_SHOW_RETRY_BATTLE_COMMENT                    0x4052 // 再戦用のメッセージを表示させるかどうか
...
#define VAR_DELIBIRD_EGG_PURCHASE_COUNT                  0x40F7 // Unused Var
