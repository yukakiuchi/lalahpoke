...
enum __attribute__((packed)) Move
{
    ...
    MOVE_SHADOW_KICK = 862,
    MOVE_ELECTRIC_SONIC_BOOM = 863,
    MOVE_THUNDER_CLOUD = 864,
    MOVE_THUNDER_STORM = 865,
    MOVE_VOLT_CANNON = 866,
    MOVE_STATIC_BUBBLE = 867,
    MOVE_ELECTRIC_BUBBLE = 868,
    MOVE_RAINBOW_BUBBLE = 869,
    MOVE_BUG_BREATH = 870,
    MOVE_RAINBOW_BUBBLE_BEAM = 871,
    MOVE_NUMBING_SEA_WATER = 872,
    MOVE_WOOD_THROW = 873,
    MOVE_WOOD_SLIDE = 874,
    MOVE_ICE_THROW = 875,
    MOVE_MAGMA_THROW = 876,
    MOVE_MAGMA_SLIDE = 877,
    MOVE_SPROUT_SHOWER = 878,
    MOVE_HOT_SAND = 879,
    MOVE_COLD_SAND = 880,
    MOVE_STATIC_SAND = 881,
    MOVE_BUTTERFLY_POWDER = 882,
    MOVE_STATIC_SCRATCH = 883,
    MOVE_BUBBLE_SCRATCH = 884,
    MOVE_FIRE_SCRATCH = 885,
    MOVE_DARK_SCRATCH = 886,
    MOVE_BUG_SCRATCH = 887,
    MOVE_STATIC_FURY_SWIPES = 888,
    MOVE_BUBBLE_FURY_SWIPES = 889,
    MOVE_FIRE_FURY_SWIPES = 890,
    MOVE_DARK_FURY_SWIPES = 891,
    MOVE_BUG_FURY_SWIPES = 892,
    MOVE_POISON_SLASH = 893,
    MOVE_MANTIS_SLASH = 894,
    MOVE_BUG_WEB = 895,
    MOVE_FLAP = 896,
    MOVE_PUNISH_SLAP = 897,
    MOVE_FALCON_SLASH = 898,
    MOVE_ICE_POWDER = 899,
    MOVE_VOLCANIC_ASH = 900,
    MOVE_SINGLE_AXEL = 901,
    MOVE_DOUBLE_AXEL = 902,
    MOVE_ANGEL_KISS = 903,
    MOVE_RAINBOW_STORM = 904,
    MOVE_BUTTERFLY_DANCE = 905,
    MOVE_BUTTERFLY_TWISTER = 906,
    MOVE_BUTTERFLY_STORM = 907,
    MOVE_SONIC_SOUL_SLASH = 908,
    MOVE_POISON_SHURIKEN = 909,
    MOVE_AAA = 910,
    MOVES_COUNT_GEN9,
