...
enum __attribute__((packed)) Move
{
    ...
    // ここから自分が追加した技
    MOVE_MISTY_FOG = 848,
    MOVE_MEADOW_BREEZE = 849,
    MOVE_GRASSY_WIND = 850,
    MOVE_GRASSY_STORM = 851,
    MOVE_SPRING_BREEZE = 852,
    MOVE_SPRING_WIND = 853,
    MOVE_WINTER_SIGH = 854,
    MOVE_FROST_BOREA = 855,
    MOVE_SOLSTICE_WIND = 856,
    MOVE_BURNING_WIND = 857,
    MOVE_FIRE_STORM = 858,
    MOVE_OMINOUS_CLOUD = 859,
    MOVE_GLOOM_WIND = 860,
    MOVE_MIDNIGHT_STORM = 861,
    MOVE_RAINY_BREEZE = 862,
    MOVE_HYDRO_WIND  = 863,
    MOVE_HYDRO_STORM = 864, 
    MOVE_SHADOW_KICK = 865,
    MOVE_ELECTRIC_SONIC_BOOM = 866,
    MOVE_THUNDER_CLOUD = 867,
    MOVE_THUNDER_STORM = 868,
    MOVE_VOLT_CANNON = 869,
    MOVE_STATIC_BUBBLE = 870,
    MOVE_ELECTRIC_BUBBLE = 871,
    MOVE_RAINBOW_BUBBLE = 872,
    MOVE_BUG_BREATH = 873,
    MOVE_RAINBOW_BUBBLE_BEAM = 874,
    MOVE_NUMBING_SEA_WATER = 875,
    MOVE_WOOD_THROW = 876,
    MOVE_WOOD_SLIDE = 877,
    MOVE_ICE_THROW = 878,
    MOVE_MAGMA_THROW = 879,
    MOVE_MAGMA_SLIDE = 880,
    MOVE_SPROUT_SHOWER = 881,
    MOVE_HOT_SAND = 882,
    MOVE_COLD_SAND = 883,
    MOVE_STATIC_SAND = 884,
    MOVE_BUTTERFLY_POWDER = 885,
    MOVE_STATIC_SCRATCH = 886,
    MOVE_BUBBLE_SCRATCH = 887,
    MOVE_FIRE_SCRATCH = 888,
    MOVE_DARK_SCRATCH = 889,
    MOVE_BUG_SCRATCH = 890,
    MOVE_STATIC_FURY_SWIPES = 891,
    MOVE_BUBBLE_FURY_SWIPES = 892,
    MOVE_FIRE_FURY_SWIPES = 893,
    MOVE_DARK_FURY_SWIPES = 894,
    MOVE_BUG_FURY_SWIPES = 895,
    MOVE_POISON_SLASH = 896,
    MOVE_BUG_SLASH = 897,
    MOVE_BUG_WEB = 898,
    MOVE_FLAP = 899,
    MOVE_PUNISH_SLAP = 900,
    MOVE_FALCON_SLASH = 901,
    MOVE_ICE_POWDER = 902,
    MOVE_VOLCANIC_ASH = 903,
    MOVE_SINGLE_AXEL = 904,
    MOVE_DOUBLE_AXEL = 905,
    MOVE_ANGEL_KISS = 906,
    MOVE_RAINBOW_STORM = 907,
    MOVE_BUTTERFLY_DANCE = 908,
    MOVE_BUTTERFLY_TWISTER = 909,
    MOVE_BUTTERFLY_STORM = 910,
    MOVE_SONIC_SOUL_SLASH = 911,
    MOVE_POISON_SHURIKEN = 912,
    MOVE_LITTLE_STAR = 913,
    MOVE_SHINE_SHOWER = 914,
    MOVE_FALLING_STARS = 915,
    MOVE_SHINE_BOMB = 916,
    MOVE_RAINBOW_FLY = 917,
    MOVE_AAA = 918,
    MOVES_COUNT_GEN9,
