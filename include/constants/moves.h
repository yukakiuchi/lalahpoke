...
enum __attribute__((packed)) Move
{
    ...
    MOVE_RAINBOW_BUBBLE_BEAM = 869,
    MOVE_NUMBING_SEA_WATER = 870,
    MOVE_BUG_BREATH = 871,
    MOVE_WOOD_THROW = 872,
    MOVE_WOOD_SLIDE = 873,
    MOVE_ICE_THROW = 874,
    MOVE_MAGMA_THROW = 875,
    MOVE_MAGMA_SLIDE = 876,
    MOVE_SPROUT_SHOWER = 877,
    MOVE_HOT_SAND = 878,
    MOVE_COLD_SAND = 879,
    MOVE_STATIC_SAND = 880,
    MOVE_BUTTERFLY_POWDER = 881,
    MOVE_STATIC_SCRATCH = 882,
    MOVE_BUBBLE_SCRATCH = 883,
    MOVE_FIRE_SCRATCH = 884,
    MOVE_DARK_SCRATCH = 885,
    MOVE_BUG_SCRATCH = 886,
    MOVE_STATIC_FURY_SWIPES = 887,
    MOVE_BUBBLE_FURY_SWIPES = 888,
    MOVE_FIRE_FURY_SWIPES = 889,
    MOVE_DARK_FURY_SWIPES = 890,
    MOVE_BUG_FURY_SWIPES = 891,
    MOVE_POISON_SLASH = 892,
    MOVE_MANTIS_SLASH = 893,
    MOVE_BUG_WEB = 894,
    MOVE_FLAP = 895,
    MOVE_PUNISH_SLAP = 896,
    MOVE_FALCON_SLASH = 897,
    MOVE_ICE_POWDER = 898,
    MOVE_VOLCANIC_ASH = 899,
    MOVE_SINGLE_AXEL = 900,
    MOVE_DOUBLE_AXEL = 901,
    MOVE_ANGEL_KISS = 902,
    MOVE_RAINBOW_STORM = 903,
    MOVE_BUTTERFLY_DANCE = 904,
    MOVE_BUTTERFLY_TWISTER = 905,
    MOVE_BUTTERFLY_STORM = 906,
    MOVE_SONIC_SOUL_SLASH = 907,
    MOVE_POISON_SHURIKEN = 908,
    MOVE_AAA = 909,
    MOVES_COUNT_GEN9,
