...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNMADEFOG]                          = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} made it fog!"), //not in gen 5+, ability popup
    ...
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} resonates with the Mega Ring!"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Foe's Pokémon will perish in one turn!"),
    ...
    [STRINGID_TAILWINDCHARGEDPKMNWITHPOWER]         = COMPOUND_STRING("Being with Tailwind, it charged {B_DEF_NAME_WITH_PREFIX2} with power!"),
    ...
    [STRINGID_DARKTERRAIN]                           = COMPOUND_STRING("The battlefield is shrouded in darkness!"),
    ...
    [STRINGID_WEATHERHEALEDPOKE]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}’s HP was restored by\nby the surrounding influence!"),        // 天候回復メッセージ
    [STRINGID_WEATHERDAMAGEDPOKE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by the surrounding influence!"),                      // 場によるダメージメッセージ
    [STRINGID_FIELDINFLICTSPOKESTATUS]              = COMPOUND_STRING("The field inflicted {B_ATK_NAME_WITH_PREFIX}'s status!"),                              // 場による状態異常効果付与
    [STRINGID_FIELDHEALEDPOKESTATUS]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s status cleared up\nfrom the surrounding influence!"),       // 場による状態異常回復
    ...
    [STRINGID_ABILITYAURORABARRIERMSG]              = COMPOUND_STRING("Light Screen and Reflect appeared around {B_SCR_NAME_WITH_PREFIX}!"),                  // ひかりのかべとリフレクターが現れたというメッセージ
    [STRINGID_TARGETPARASITIZED]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was parasitized!"),
};
...
const u16 gAbilityWeatherChangeStringId[] =
{
    ...
    [B_MSG_STARTED_MISTY_BREATH]   = STRINGID_PKMNMADEFOG,
};
...
const u16 gTerrainStartsStringIds[] =
{
    ...
    [B_MSG_TERRAIN_SET_PSYCHIC]  = STRINGID_DARKTERRAIN,
