...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_SLUGMA)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_FLETCHLING)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_SPHEAL )
