...
const u8 gText_BagFullCouldNotReturnBall[] = _("{STR_VAR_1} tried to return its \n{STR_VAR_2} but it's full!{PAUSE_UNTIL_PRESS}");
const u8 gText_ChangedMonHeldBall[] = _("Ball swap succeeded!\n{STR_VAR_1} returned its {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromDelibirdShop[] = _("A POKéMON EGG obtained\n from a Delibird Employee.");
const u8 gText_EggFromDelibirdOutside[] = _("A POKéMON EGG obtained\n from a Delibird Outside.");
